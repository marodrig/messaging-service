...
| /messages/delete?message-id=1 | DELETE | Delete one one message with id equal to message_id | message0-id | {"message": 1, "status_code": 200}|
| /messages/delete?recipient-id=123> | DELETE | Delete one one message with id equal to message_id | recipient-id | {"message": 1, "status_code": 200}|
